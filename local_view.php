			...
			<!-- container-wrap -->
                    ...
                    <div class="col-lg-12">
                        <div class="col-lg-12">
                            ...
                            if(isset($_GET['del']))
{
    $del=mysql_query("delete from local where id='".$_GET['del']."'");
    //echo mysql_error();
    if($del>0)
    {
       header("location:local_view.php");
}
}
...
?>
                            ...
                            $a=mysql_query("select * from local where st='1'");
                            ...
                            ?>
                                <td style="width:20%"><a href="img2/<?php echo $b['logo']?>"</a><img src="img2//<?php echo $b['logo']?>" style="width:100%; height:260px;" /></a><br />
