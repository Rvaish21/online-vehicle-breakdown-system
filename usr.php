...
if(isset($_POST['sub']))
{
    ...
    $usrc=mysql_query("select * from user_data where lid='$lid'");
    ...
    $ins=mysql_query("insert into user_data values('','$onm','$lid','$pas','$addr','$con','$em','0')");
    if($ins>0)
    {
        $ins1=mysql_query("insert into user_log values('','$lid','$pas','usr','1')");
        if($ins1>0)
        {
