...
?>
                            ...
                            $a=mysql_query("select * from reg where company_id='$_SESSION[username]'");
                            ...
                            ?>
                                <td style="width:20%"><a href="img1//<?php echo $b['photo']?>"</a><img src="img1//<?php echo $b['photo']?>" style="width:100%; height:260px;" /></a><br />
                                     ...
                                     <h3 style="text-align: center;color: #1b6d85;background-color: #afd9ee" ><?php echo $b['name']?></h3>
                                <br/>
...
$sname=mysql_result($qry,0);
                                ...
                                <br/>
                                <center><a href="service_view.php?del=<?php echo $b['id']?>"class="btn btn-danger">Delete Service Station </a></center></td>
