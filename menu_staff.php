	...
	<div class="header">
		<div class="container">
				<div class="header-top">
					<div class="logo">
                                            <h1><a href="admin_home.php"><?php echo $title ?></a></h1>
					</div>
					<div class="phone">
        ...
        <!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						  <ul class="nav navbar-nav cl-effect-16">
                                                      <li><a href="staff_home.php">Home <span class="sr-only">(current)</span></a></li>
                                                     
                                                      <li><a href="staff_msg.php">Service Message</a></li>
                                                     
                                                      <li><a href="service_deta.php">All Enquiry</a></li>
