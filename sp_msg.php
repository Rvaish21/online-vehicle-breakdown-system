...
if(isset($_GET['upd']))
{
    ...
    $upd1=mysql_query("update s_help set st='1'where id='$ac'");
    
   
    if($upd1>0)
    {
        header("location:sp_msg.php");
    }
    }
...
if(isset($_GET['del']))
{
    ...
    $upd1=mysql_query("update s_help set st='2'where id='$de'");
...
@media only screen and (min-width : 480px) and (max-width : 768px) {
 ...
 <table  class="table  table-responsive  table-striped table-bordered ">
     ...
     <?php
                            ...
                            $a=mysql_query("select * from s_help where service_id='$_SESSION[username]'and st='0'order by id desc");
    ...
    <tr>
        ...
        <td><?php echo $b[5]?></td>
        <td><a href="sp_msg.php?t=1&mid=<?php echo $b[0]?>" class="glyphicon glyphicon-map-marker"style="color: darkred"></a> &nbsp;&nbsp;  <a href="sp_msg.php?upd=<?php echo $b[0] ?>"><span class="glyphicon glyphicon-ok" style="color: lightgreen"></span></a> &nbsp;&nbsp; <a href="sp_msg.php?del=<?php echo $b[0] ?>"><span class="glyphicon glyphicon-remove" style="color: red"></span></a></td>
       <?php
    $i++;
    }
